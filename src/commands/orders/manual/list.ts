...
import { CommandInteraction, EmbedBuilder, ComponentType, ButtonBuilder, ButtonStyle, Interaction, MessageComponentInteraction, MessageFlags } from "discord.js";
...
`)
			...
			await int.reply("An error occurred while processing the list command. Please try again later.");
		}
	});
